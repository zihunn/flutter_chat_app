                ...
                children: [
                  ...
                  Text(
                    DateFormat.Hm().format(
                      DateTime.parse(dataFriend["creationTime"]),
                    ),
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.white,
              ...
              () => (controller.isShowEmoji.isTrue)
                  ? Container(
                      ...
                      child: EmojiPicker(
                        ...
                        config: Config(
                          backspaceColor: Colors.blue.withOpacity(0.6),
                          columns: 7,
                          emojiSizeMax: 32.0,
                          verticalSpacing: 0,
                          horizontalSpacing: 0,
                          ...
                          iconColorSelected: Colors.blue.withOpacity(0.6),
